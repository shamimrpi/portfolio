...
@section('main_content')
	<div class="box">
		<div class="card-body">
			<div class="container">
				<a href="{{route('skills')}}" class="btn btn-info fa fa-plus float-sm-right"> Back Contact</a>
				<form action="{{route('contacts.store')}}" method="POST" id="skillsForm" enctype="multipart/form-data">
					@csrf
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="name" placeholder="Enter Contact ">
							</div>
						</div>
